...
public class ProfileActivity extends AppCompatActivity {
    ...
    private int[] pics={R.drawable.afghanistan_details,R.drawable.algeria_details,R.drawable.bangladesh_details,R.drawable.brazil_details,R.drawable.canada_details,R.drawable.croatia_details,
            ...
            R.drawable.russia_details,R.drawable.somalia_details,R.drawable.switzerland_details,R.drawable.syria_details,R.drawable.thailand_details,R.drawable.tuvalu_details,R.drawable.uganda_details,R.drawable.uruguay_details,
